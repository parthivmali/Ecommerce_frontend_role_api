...
import { XMarkIcon, Bars3Icon, MagnifyingGlassIcon, ShoppingBagIcon } from '@heroicons/react/24/outline'
            ...
            <div className="flex h-16 items-center">
              ...
              {checkedLogin ? 
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <Link to={"/user-register"} className="text-sm font-medium text-gray-700 hover:text-gray-800">
                    Create account
                  </Link>
                </div>
              :
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <p onClick={handleLogoutClick} className="text-sm font-medium text-gray-700 hover:text-gray-800 cursor-pointer">
                    Sign out
                  </p>
                </div>
